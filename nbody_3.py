...
"""
    N-body simulation.
    Modification: Using local rather than global variables
    Runtime: 468.88711381 / 3 = 156.2957046033
    R = L_orig / L_opt = 1.0057

    We can see that using local variables barely speed up the compute time.
"""
import timeit
